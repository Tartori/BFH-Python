...
motor_action_transitions = {
    ...
    'open':  lambda input: None,        # YOUR CODE HERE
    'opening': lambda input: None,      # YOUR CODE HERE
    'closing': lambda input: None,      # YOUR CODE HERE
    'error': lambda input: None         # YOUR CODE HERE
}
