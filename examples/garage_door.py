...
motor_action_transitions = {
    ...
    'open':  lambda input: MotorAction.DOWN if input.close_button else MotorAction.OFF,        # YOUR CODE HERE
    'opening': lambda input: MotorAction.OFF if input.limit_switch_open else (
        MotorAction.DOWN if input.close_button else MotorAction.UP),      # YOUR CODE HERE
    'closing': lambda input: MotorAction.OFF if input.limit_switch_closed else (
        MotorAction.UP if input.open_button else MotorAction.DOWN),      # YOUR CODE HERE
    'error': lambda input: MotorAction.OFF         # YOUR CODE HERE
}
